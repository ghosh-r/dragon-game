def tick args
  ...
  if args.inputs.keyboard.key_down.z || args.inputs.keyboard.key_down.z || args.inputs.controller_one.key_down.a
    args.state.fireballs << [args.state.player_x, args.state.player_y,
    'fireball']
  end
